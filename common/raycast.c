...
/*   Updated: 2022/01/08 12:40:03 by graja            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static
float	ft_firstHitHorizontal(t_data *d, float alpha)
{
	float	diffY;
	float	diffX;
	size_t	px;
	...
	return (ft_getDist(px, py, diffX, diffY));
}
 ...
 */
static
float	ft_firstHitVertical(t_data *d, float alpha)
{
	float	diffY;
	float	diffX;
	size_t	px;
